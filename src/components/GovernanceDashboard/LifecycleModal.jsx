      ...
      <div className="modal">
        ...
        <div className="modal-meta-bar">
          <div className="meta-item">
            ...
            <span className="meta-value">{data.lifecycle || "LC-UNK"}</span>
          </div>
          <div className="meta-item">
            <span className="meta-label">TICKET</span>
            <span className="meta-value">{data.ticket_id}</span>
          </div>
          <div className="meta-item">
            <span className="meta-label">PRIORITY</span>
            <span className="meta-value">{data.severity}</span>
          </div>
          <div className="meta-item">
          ...
          <div className="meta-item">
            ...
            <span className="meta-value">{data.eta || "00:00:00"}</span>
          </div>
          <div className="meta-item">
