                ...
                >
                  ...
                  {m.role === "bot" && m.text !== "Thinking..." && (
                    <div style={{ display: "flex", gap: "10px", marginLeft: "15px" }}>
                      ...
                      >
                        <svg viewBox="-8 -8 38 38" className={`like-btn ${m.feedback === "like" ? "selected" : ""}`} width="28" height="28" xmlns="http://www.w3.org/2000/svg">
                      ...
                      >
                        <svg viewBox="-8 -8 38 38" className={`dislike-btn ${m.feedback === "dislike" ? "selected" : ""}`} width="28" height="28" xmlns="http://www.w3.org/2000/svg">
