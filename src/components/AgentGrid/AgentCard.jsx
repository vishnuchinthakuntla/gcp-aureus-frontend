...
const AgentCard = ({ agent }) => {
  ...
  return (
    ...
    >
      ...
      <div className="score-label">{label.toUpperCase()}</div>
      <div className="score-value" style={{ color: numColor }}>{agent.id === "self_service" || agent.id === "governance" ? "" : count}</div>
      {/* agent.id !== "self_service" && agent.id !== "governance" && <div className="agent-card__status">
