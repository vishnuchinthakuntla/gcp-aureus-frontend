    ...
    <nav className="topnav">
      ...
      <div className="page-title-main">
        ...
        <div className="page-subtitle">
          Real-time intelligence · {info.agent_count || "7"} agents · Last
          refresh: <span>{info.last_refresh || "—"}</span>
        </div>
      </div>
      <div className="nav-pill">
        <span style={{ color: "#ffffff" }}>
          Welcome,{" "}
          <span style={{ color: "#ffffff" }}>{info.user_name || "User"}</span>
        </span>
        <div className="page-header-meta">
          <span className="meta-chip meta-chip-blue">
            {info.agent_count || "7"} AGENTS
          </span>
